...
var G__28541 = format;
var G__28541__$1 = (((G__28541 instanceof cljs.core.Keyword))?G__28541.fqn:null);
switch (G__28541__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__28542 = cljs.core.second(format);
var G__28543 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__28542,G__28543) : ajax.easy.keyword_response_format_element.call(null,G__28542,G__28543));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28545_SHARP_){
return ajax.easy.keyword_response_format_element(p1__28545_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__28547){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28548__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28548__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28548__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__28550){
var vec__28551 = p__28550;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28551,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28551,(1),null);
var fexpr__28554_28565 = (cljs.core.truth_(ok)?h:e);
(fexpr__28554_28565.cljs$core$IFn$_invoke$arity$1 ? fexpr__28554_28565.cljs$core$IFn$_invoke$arity$1(result) : fexpr__28554_28565.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__28555){
...
var opts = map__28556__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28556__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28556__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28556__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28556__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28556__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
