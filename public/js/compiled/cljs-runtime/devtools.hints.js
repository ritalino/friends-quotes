...
var map__29010 = top_item;
var map__29010__$1 = (((((!((map__29010 == null))))?(((((map__29010.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29010.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29010):map__29010);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29010__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29010__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29010__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e29009){var _e = e29009;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___29023 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___29023)){
var seen_errors_29024 = temp__5733__auto___29023;
if(cljs.core.truth_(seen_errors_29024.has(self))){
} else {
seen_errors_29024.add(self);

var temp__5735__auto___29026 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___29026)){
var sense_29027 = temp__5735__auto___29026;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_29027)].join(''));
} else {
}
}
} else {
