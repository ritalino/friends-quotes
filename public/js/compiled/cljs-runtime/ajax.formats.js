...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__28500){
...
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28501__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__28508 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__28508.cljs$core$IFn$_invoke$arity$1 ? fexpr__28508.cljs$core$IFn$_invoke$arity$1(response) : fexpr__28508.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__28509 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__28509.cljs$core$IFn$_invoke$arity$1 ? fexpr__28509.cljs$core$IFn$_invoke$arity$1(response) : fexpr__28509.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__28510){
...
var request = map__28511__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28511__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
