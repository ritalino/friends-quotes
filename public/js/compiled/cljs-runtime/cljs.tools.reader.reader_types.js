...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_30726 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_30726(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_30727 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_30727(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30733 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30733(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30734 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30734(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30735 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30735(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30736 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30736(reader);
}
});
