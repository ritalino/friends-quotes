...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_28192 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_28192(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_28195 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_28195(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_28197 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_28197(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_28200 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_28200(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_28206 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_28206(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_28209 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_28209(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_28217 = (function (this$,header){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_28217(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_28230 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_28230(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_28245 = (function (this$,request){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_28245(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_28267 = (function (this$,response){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_28267(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k28179,else__4383__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__28184){
var vec__28185 = p__28184;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28185,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28185,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__28178){
var self__ = this;
var G__28178__$1 = this;
return (new cljs.core.RecordIter((0),G__28178__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this28180,other28181){
var self__ = this;
var this28180__$1 = this;
return (((!((other28181 == null)))) && ((this28180__$1.constructor === other28181.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this28180__$1.status,other28181.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this28180__$1.body,other28181.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this28180__$1.status_text,other28181.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this28180__$1.headers,other28181.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this28180__$1.was_aborted,other28181.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this28180__$1.__extmap,other28181.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__28178){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__28188 = cljs.core.keyword_identical_QMARK_;
var expr__28189 = k__4388__auto__;
if(cljs.core.truth_((pred__28188.cljs$core$IFn$_invoke$arity$2 ? pred__28188.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__28189) : pred__28188.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__28189)))){
return (new ajax.protocols.Response(G__28178,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__28188.cljs$core$IFn$_invoke$arity$2 ? pred__28188.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__28189) : pred__28188.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__28189)))){
return (new ajax.protocols.Response(self__.status,G__28178,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__28188.cljs$core$IFn$_invoke$arity$2 ? pred__28188.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__28189) : pred__28188.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__28189)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__28178,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__28188.cljs$core$IFn$_invoke$arity$2 ? pred__28188.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__28189) : pred__28188.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__28189)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__28178,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__28188.cljs$core$IFn$_invoke$arity$2 ? pred__28188.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__28189) : pred__28188.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__28189)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__28178,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__28178),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__28178){
var self__ = this;
var this__4379__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__28178,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__28182){
var extmap__4419__auto__ = (function (){var G__28191 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__28182,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
...
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__28182),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__28182),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__28182),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__28182),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__28182),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
