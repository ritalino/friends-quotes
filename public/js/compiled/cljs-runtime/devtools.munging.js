...
var o28333 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28333["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28334 = temp__5733__auto____$1;
return (o28334["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27773__auto__ = f;
return (o__27773__auto__["toString"]).call(o__27773__auto__);
} else {
return "";
}
}catch (e28340){var _ = e28340;
return "";
}});
...
try{var o__27773__auto___28801 = t;
(o__27773__auto___28801["cljs$lang$ctorPrWriter"]).call(o__27773__auto___28801,t,writer);
}catch (e28344){var __28802 = e28344;
}
...
var char_code = (function (){var o__27773__auto__ = (new String(char$));
return (o__27773__auto__["charCodeAt"]).call(o__27773__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27773__auto__ = String;
return (o__27773__auto__["fromCharCode"]).call(o__27773__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28354 = num_code;
switch (G__28354) {
case (1):
return (185);
...
var o__27773__auto__ = String;
return (o__27773__auto__["fromCharCode"]).call(o__27773__auto__,superscript_code);
});
/**
...
}catch (e28378){var _e__27840__auto__ = e28378;
return false;
}})())){
...
var vec__28381 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28381,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o28425 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28425["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28426 = temp__5733__auto____$1;
return (o28426["nameToPath"]);
} else {
return null;
}
} else {
...
var G__28830 = (i__4737__auto___28828 + (1));
i__4737__auto___28828 = G__28830;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28440){
var vec__28443 = p__28440;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28443,(0),null);
...
var G__28833 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28834 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28833;
remaining_tokens = G__28834;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28432){
...
var vec__28455 = cljs.core.split_with((function (p1__28454_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28454_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28455,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28455,(1),null);
...
var vec__28467 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28467,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28467,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28845 = cljs.core.rest(remaining_tokens);
var G__28846 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28845;
name_tokens = G__28846;
continue;
} else {
...
var vec__28502 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28502,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28502,(1),null);
var vec__28506 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28506,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28506,(1),null);
var vec__28509 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28509,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28509,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28509,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28509,(3),null);
...
var vec__28546 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28546,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28546,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28546,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28546,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28546,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28546,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__28559 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28559,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28559,(1),null);
var vec__28562 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28562,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28562,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28569 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28569) : devtools.munging.parse_fn_info_deep.call(null,G__28569));
})()));
}
} else {
return fn_info;
...
var G__28890 = (arity + (1));
var G__28891 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28615_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28615_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28617_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28617_SHARP_);
}),sorted_infos);
...
while(true){
if((i__4737__auto___28915 < len__4736__auto___28913)){
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28637){
var vec__28638 = p__28637;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28638,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28625){
var G__28626 = cljs.core.first(seq28625);
var seq28625__$1 = cljs.core.next(seq28625);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28626,seq28625__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28695__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28695__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28695__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28695__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28696 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28696,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28696,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28696,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28696,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28696,(4),null);
...
var o__27773__auto__ = f;
return (o__27773__auto__["getBasis"]).call(o__27773__auto__);
});
/**
...
}catch (e28711){var _e__27840__auto__ = e28711;
...
var G__28934 = (obj[cljs.core.first(path)]);
var G__28935 = cljs.core.rest(path);
obj = G__28934;
path = G__28935;
continue;
} else {
...
var _STAR_ = (function (accum,p__28744){
var vec__28745 = p__28744;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28745,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28745,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28763){
...
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28764,(2),null);
...
var post_process = (function (p__28783){
var vec__28784 = p__28783;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28784,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28784,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28777_SHARP_){
return (obj[cljs.core.first(p1__28777_SHARP_)]);
}),sorted_matches);
