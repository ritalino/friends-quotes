...
var G__29025 = devtools.prefs.pref(v);
v = G__29025;
continue;
} else {
return v;
...
}catch (e28990){var _e__27840__auto__ = e28990;
return false;
}})();
...
}catch (e28999){var _e__27840__auto__ = e28999;
return false;
}})();
...
}catch (e29003){var _e__27840__auto__ = e29003;
return false;
}}
}
});
...
var vec__29013 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29013,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29013,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__29016_SHARP_);
}),template);
});
